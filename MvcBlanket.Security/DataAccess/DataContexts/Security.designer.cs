...
namespace MvcBlanket.Security.DataAccess
{
    ...
    partial void InsertRole(MvcBlanket.Security.DataAccess.DataContexts.Role instance);
    partial void UpdateRole(MvcBlanket.Security.DataAccess.DataContexts.Role instance);
    partial void DeleteRole(MvcBlanket.Security.DataAccess.DataContexts.Role instance);
    partial void InsertUser2Role(MvcBlanket.Security.DataAccess.DataContexts.User2Role instance);
    partial void UpdateUser2Role(MvcBlanket.Security.DataAccess.DataContexts.User2Role instance);
    partial void DeleteUser2Role(MvcBlanket.Security.DataAccess.DataContexts.User2Role instance);
    partial void InsertUser(MvcBlanket.Security.DataAccess.DataContexts.User instance);
    partial void UpdateUser(MvcBlanket.Security.DataAccess.DataContexts.User instance);
    partial void DeleteUser(MvcBlanket.Security.DataAccess.DataContexts.User instance);
    partial void InsertUser2ParentUser(MvcBlanket.Security.DataAccess.DataContexts.User2ParentUser instance);
    partial void UpdateUser2ParentUser(MvcBlanket.Security.DataAccess.DataContexts.User2ParentUser instance);
    partial void DeleteUser2ParentUser(MvcBlanket.Security.DataAccess.DataContexts.User2ParentUser instance);
    #endregion
		
		public SecurityDataContext() : 
				base(global::MvcBlanket.Security.Properties.Settings.Default.SecurityConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<MvcBlanket.Security.DataAccess.DataContexts.Role> Roles
		{
			get
			{
				return this.GetTable<MvcBlanket.Security.DataAccess.DataContexts.Role>();
			}
		}
		
		public System.Data.Linq.Table<MvcBlanket.Security.DataAccess.DataContexts.User2Role> User2Roles
		{
			get
			{
				return this.GetTable<MvcBlanket.Security.DataAccess.DataContexts.User2Role>();
			}
		}
		
		public System.Data.Linq.Table<MvcBlanket.Security.DataAccess.DataContexts.User> Users
		{
			get
			{
				return this.GetTable<MvcBlanket.Security.DataAccess.DataContexts.User>();
			}
		}
		
		public System.Data.Linq.Table<MvcBlanket.Security.DataAccess.DataContexts.User2ParentUser> User2ParentUsers
		{
			get
			{
				return this.GetTable<MvcBlanket.Security.DataAccess.DataContexts.User2ParentUser>();
			}
		}
	}
}
namespace MvcBlanket.Security.DataAccess.DataContexts
{
	using System.Data.Linq;
	using System.Data.Linq.Mapping;
    ...
    partial void OnSaltChanging(byte[] value);
    ...
    partial void OnActivationKeyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Password", DbType="Binary(64)", UpdateCheck=UpdateCheck.Never)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Salt", DbType="binary(8) NOT NULL", CanBeNull=false)]
		public byte[] Salt
		{
			get
			{
